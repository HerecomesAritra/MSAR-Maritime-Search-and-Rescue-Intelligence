...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D6ZOS8OJ.mjs");
...
var manifest = {
	"a5c81c9f55c2de11d424e7905fd5c9cb48eb5e4128a9eabe2da482570eb31efb": {
		functionName: "runCopilotOnServer_createServerFn_handler",
		importer: () => import("./copilot.server-CCflKBhC.mjs")
	},
	"b7b3423cb3549104def5b29b2a3d3bf83b968a99f7732f9da9e57dc964de5809": {
		functionName: "runDecisionOnServer_createServerFn_handler",
		importer: () => import("./decision.server-C395Lar6.mjs")
	},
	"baa0676f1070d423137b3e9b4e13d8a8989b0386bef6a2bf6dc19c73e74084b6": {
		functionName: "runTriageOnServer_createServerFn_handler",
		importer: () => import("./triage.server-VQ7XjmMi.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BKh8Yqy8.mjs"),
		import("./start-BJNw0tgY.mjs"),
